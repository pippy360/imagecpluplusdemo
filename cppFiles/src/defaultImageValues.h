...
#define USE_DILATE true
#define USE_ERODE_BEFORE false
#define USE_ERODE_AFTER true

#define EROSION_BEFORE_SIZE 0
#define DILATE_SIZE 0
#define EROSION_AFTER_SIZE 0
