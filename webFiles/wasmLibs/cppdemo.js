...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 748944,
    DYNAMIC_BASE = 5991824,
    DYNAMICTOP_PTR = 748016;
...
var ASM_CONSTS = {
  130768: function() {throw 'Canceled!'}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=748928;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 748176;
