...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 748912,
    DYNAMIC_BASE = 5991792,
    DYNAMICTOP_PTR = 747984;
...
var ASM_CONSTS = {
  130736: function() {throw 'Canceled!'}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=748896;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 748144;
...
var dynCall_iiiiiddiiiii = Module["dynCall_iiiiiddiiiii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiiiiddiiiii"].apply(null, arguments)
};
